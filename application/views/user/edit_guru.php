<?php $this->load->view('templates/header', ['title' => 'Edit Super Admin']); ?>

<h3>Edit Super Admin (Guru)</h3>

<?php echo validation_errors('<div class="alert alert-danger">', '</div>'); ?>

<form method="post" action="<?php echo site_url('user/edit_guru/'.$user->id_user); ?>">
  <div class="mb-3">
    <label>Nama</label>
